...
/* #############################################################
   ...
   ############################################################# */
static void 
_slideshow_delete_cb(void *data EINA_UNUSED, Evas_Object *obj EINA_UNUSED, void *event_info EINA_UNUSED)
{	
    Evas_Object *o_edje;
...
static void
_browser_cb_root (void *data EINA_UNUSED, Evas_Object *obj EINA_UNUSED, void *event_info EINA_UNUSED)
{
    enna_content_hide();
}

static void
_browser_cb_selected (void *data EINA_UNUSED, Evas_Object *obj EINA_UNUSED, void *event_info)
{
...
static void
_browser_cb_hilight (void *data EINA_UNUSED, Evas_Object *obj EINA_UNUSED, void *event_info)
{
    Enna_File *file = event_info;
    Evas_Object *o_edje;
